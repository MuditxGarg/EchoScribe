from realtime_utils import array_buffer_to_base64, base64_to_array_buffer
import traceback
import inspect
import numpy as np
...
from realtime_config import Config
#rom tools import available_functions, tools_list


base_url = f"wss://{Config.az_open_ai_endpoint_name}.openai.azure.com/"
